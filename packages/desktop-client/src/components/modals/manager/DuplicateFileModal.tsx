            ...
            >
              ...
              {isLocalFile ? (
                isCloudFile && (
                  <Text>
                    <Trans>
                      Your budget is hosted on a server, making it accessible
                      for download on your devices.
                      <br />
                      Would you like to duplicate this budget for all your
                      devices or keep it stored locally on this device?
                    </Trans>
                  </Text>
                )
              ) : (
                <Text>
                  <Trans>
                    ...
                    device.
                    <br />
                    Please download the budget from the server before
                    duplicating.
                  </Trans>
                </Text>
              )}
