            ...
            >
              {isCloudFile &&
                (canDeleteFromServer ? (
                  <>
                    <Text>
                      <Trans>
                        ...
                        stored on your server to make it available for download
                        on any device. You can delete it from the server, which
                        will also remove it from all of your devices.
                      </Trans>
                    </Text>
                  ...
                  <Text>
                    <Trans>
                      This is a <strong>hosted file</strong> shared with you.
              ...
              {'id' in file && (
                <>
                  {isCloudFile ? (
                    <Text>
                      <Trans>
                        You can also delete just the local copy. This will
                        remove all local data and the file will be listed as
