                ...
                <>
                  ...
                  <Paragraph>
                    ...
                    >
                      <li>
                        <Trans>
                          <strong>Important:</strong> if you forget this
                          password <em>and</em> you don't have any local copies
                          of your data, you will lose access to all your data.
                          The data cannot be decrypted without the password.
                        </Trans>
                      </li>
                      <li>
                        <Trans>
                      ...
                      <li>
                        <Trans>
                          If you've already downloaded your data on other
                          devices, you will need to reset them. Actual will
                ...
                <>
                  <Paragraph style={{ marginTop: 5 }}>
                    <Trans>
                      ...
                      Actual will take you through that process on those
                      devices.
                    </Trans>{' '}
                    <Link
                      variant="external"
                  ...
                  <Paragraph>
                    <Trans>
                      Key generation is randomized. The same password will
                      create different keys, so this will change your key
                      regardless of the password being different.
                    </Trans>
                  </Paragraph>
                </>
              )}
